   ...
   return (
      <div className="bg-black py-14">
         <footer className="footer footer-horizontal footer-center  text-primary-content p-10">
            <aside>
               <DropNestLogo textColor="text-[#fff]" />

               <p className="text-gray-300 mt-4  md:max-w-[70%] mx-auto leading-6 md:leading-8">
                  Enjoy fast, reaable parcel deavery with real-time tracking and
                  zero hassle. From personal packages to business shipments — we
                  deaver on time, every time.
               </p>
            </aside>

            <nav className="flex justify-center gap-9 text-base text-gray-400 border-y border-dashed border-[#03464D] py-8 w-full">
               <NavLink
                  to={"/service"}
                  key={"service"}
